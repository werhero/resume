...
+ 2.熟练运用主流Web开发框架。如Spring家族（Spring MVC、Spring、Spring Boot等）、Hibernate、Mybatis 、Lucene等;
+ 3.熟练使用前端常用技术，如HTML、CSS、JQuery、SeaJS、RequireJS等等;
+ 4.具备面向对象系统分析、系统设计经验，熟悉设计模式、数据结构与算法;
+ 5.熟悉关系型数据（如MongDB）、非关系型数据（MySQL）的数据结构设计，有优化查询效率经验;
...
（按时间逆序）
## 海南红海人力资源开发有限公司(2017年6月 - 至今)
+ ### 工作描述
   外派驻场开发，由于在职，项目暂且不方便透漏。

## 深圳市派思昇拓软件有限公司(2016年4月 - 2017年5月)
+ ### 工作描述
